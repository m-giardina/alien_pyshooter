    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_play_button(ai_settings, screen, stats, sb, play_button, ship,
                aliens, bullets, explosions, mouse_x, mouse_y)
...
def update_screen(ai_settings, stats, screen, sb, ship, aliens, bullets, explosions, play_button):
